...
var usernameCheck = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                user = _a.sent();
                if (user) {
                    return [2 /*return*/, res.status(405).send({ message: 'Username already exists.' })];
                }
